...
type ProviderServiceClient interface {
	...
	KoyoList(context.Context, *connect.Request[v1.KoyoListRequest]) (*connect.Response[v1.KoyoListResponse], error)
...
func (c *providerServiceClient) KoyoList(ctx context.Context, req *connect.Request[v1.KoyoListRequest]) (*connect.Response[v1.KoyoListResponse], error) {
	return c.koyoList.CallUnary(ctx, req)
}
...
func NewProviderServiceHandler(svc ProviderServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	providerServiceKoyoListHandler := connect.NewUnaryHandler(
...
func (UnimplementedProviderServiceHandler) KoyoList(context.Context, *connect.Request[v1.KoyoListRequest]) (*connect.Response[v1.KoyoListResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("belifeline.v1.ProviderService.KoyoList is not implemented"))
}
