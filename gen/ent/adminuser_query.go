...
func (auq *AdminUserQuery) FirstID(ctx context.Context) (id pulid.ID, err error) {
	var ids []pulid.ID
...
func (auq *AdminUserQuery) FirstIDX(ctx context.Context) pulid.ID {
...
func (auq *AdminUserQuery) OnlyID(ctx context.Context) (id pulid.ID, err error) {
	var ids []pulid.ID
...
func (auq *AdminUserQuery) OnlyIDX(ctx context.Context) pulid.ID {
...
func (auq *AdminUserQuery) IDs(ctx context.Context) (ids []pulid.ID, err error) {
...
func (auq *AdminUserQuery) IDsX(ctx context.Context) []pulid.ID {
	ids, err := auq.IDs(ctx)
	if err != nil {
		panic(err)
	}
