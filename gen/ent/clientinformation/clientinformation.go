...
const (
	// Label holds the string label denoting the clientinformation type in the database.
	...
	// Table holds the table name of the clientinformation in the database.
	Table = "client_informations"
)

// Columns holds all SQL columns for clientinformation fields.
var Columns = []string{
	FieldID,
	FieldUsername,
	FieldAPIKey,
...
// OrderOption defines the ordering options for the ClientInformation queries.
